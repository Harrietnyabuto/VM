...
class UserRegister(Resource):
    def post(self):
        ...
        new_user = User(username=data.username, email=data.email, password=bcrypt.generate_password_hash(
...
class Login(Resource):
    def post(self):
        ...
        return {"access_token": token, "user_id": user.id, "username": user.username, "created_at": user.created_at.isoformat()}
